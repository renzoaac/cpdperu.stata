...
cd "D:\OneDrive - Superintendencia Nacional de Servicios de Saneamiento\Escritorio\renzo\pagina\cpdperu stata\abrir_cargar_datos" // Aquí debes ingresar la ruta en donde albergas tus archivos
...
tsline consumo, name(graph1, replace)
tsline PBI, name(graph2, replace)
...
tabstat INGMO2HD
tabstat INGMO2HD, s(sk k med mean n)
